...
if __name__ == '__main__':
    weights_file = './PaddleDetection-2.4.0/out_s_fp16.engine'
    input_image_path = './images/bus.jpg'
    output_image_path = './bus.jpg'

    det = Detection(weights_file)
    origin_image = cv2.imread(input_image_path)
    results = det.predict(origin_image, threshold=0.5)
    print('bbox', results)
    result = visualize(origin_image, results)
